...
jest.mock('../src/index', () => {
    ...
    app.post('/chart-of-accounts', (req, res) => {
    ...
    app.get('/companies/:id/documents', (req, res) => {
        res.status(200).json([
            {
                id: 1,
                filename: 'test-document.pdf',
    ...
    app.post('/documents/:id/process-ocr', (req, res) => {
        res.status(200).json({
            id: 1,
            filename: 'test-document.pdf',
            originalName: 'test-document.pdf',
    ...
    app.get('/companies/:id/bank-accounts', (req, res) => {
        res.status(200).json([
            {
                id: 1,
                accountName: 'Main Business Account',
    ...
    app.post('/bank-accounts/:id/import-transactions', (req, res) => {
        res.status(201).json([
            {
                id: 1,
                externalId: 'ext-123',
    ...
    app.post('/transactions/:id/categorize', (req, res) => {
        res.status(200).json({
            id: 1,
            confidence: 0.92,
            source: 'AI_MODEL',
    ...
    app.post('/financial-reports', (req, res) => {
        res.status(201).json({
            id: 1,
    ...
    app.get('/companies/:id/financial-reports', (req, res) => {
        res.status(200).json([
            {
                id: 1,
                name: 'Q1 2024 Financial Report',
    ...
    app.get('/companies/:id/dashboards', (req, res) => {
        res.status(200).json([
            {
                id: 1,
                name: 'Executive Dashboard',
    ...
    app.get('/companies/:id/kpis', (req, res) => {
        res.status(200).json([
            {
                id: 1,
                name: 'Revenue Growth',
    ...
    app.get('/companies/:id/payrolls', (req, res) => {
        res.status(200).json([
            {
                id: 1,
                name: 'January 2024 Payroll',
...
describe('Backend API Tests', () => {
    let app;
    beforeAll(async () => {
        app = await Promise.resolve().then(() => __importStar(require('../src/index')));
    });
    ...
    it('should return health status on GET /health', async () => {
        ...
        const res = await (0, supertest_1.default)(testApp).get('/health');
        expect(res.status).toBe(200);
    ...
    it('should initiate BankID authentication on POST /auth/initiate', async () => {
        ...
        testApp.post('/auth/initiate', (req, res) => {
            res.status(200).json({
                orderRef: 'mock-order-ref',
                autoStartToken: 'mock-auto-start-token',
                qrStartToken: 'mock-qr-start-token',
        ...
        const res = await (0, supertest_1.default)(testApp)
            .post('/auth/initiate')
    ...
    it('should collect BankID authentication status on POST /auth/collect', async () => {
        ...
        const testApp = express();
        testApp.use(express.json());
        testApp.post('/auth/collect', (req, res) => {
            const { orderRef } = req.body;
            if (!orderRef) {
                return res.status(400).json({ error: 'orderRef is required' });
            }
    ...
    it('should cancel BankID authentication on POST /auth/cancel', async () => {
        ...
        const testApp = express();
        testApp.use(express.json());
        testApp.post('/auth/cancel', (req, res) => {
            const { orderRef } = req.body;
            if (!orderRef) {
                return res.status(400).json({ error: 'orderRef is required' });
            }
    ...
    it('should create a company on POST /companies', async () => {
        ...
        const testApp = express();
        testApp.use(express.json());
        testApp.post('/companies', (req, res) => {
            const { name, organizationNumber } = req.body;
            res.status(201).json({
                id: 1,
                name,
    ...
    it('should create a chart of accounts on POST /chart-of-accounts', async () => {
        ...
        const testApp = express();
        testApp.use(express.json());
        testApp.post('/chart-of-accounts', (req, res) => {
            const { name, code } = req.body;
            res.status(201).json({
                id: 1,
                name,
    ...
    it('should create a transaction on POST /transactions', async () => {
        ...
        const testApp = express();
        testApp.use(express.json());
        testApp.post('/transactions', (req, res) => {
            const { accountId, amount, type } = req.body;
            res.status(201).json({
                id: 1,
                accountId,
    ...
    it('should upload a document on POST /documents/upload', async () => {
        ...
        const testApp = express();
        testApp.use(express.json());
        testApp.post('/documents/upload', (req, res) => {
            res.status(201).json({
                id: 1,
                filename: 'test-document.pdf',
                originalName: 'test-document.pdf',
    ...
    it('should process document OCR on POST /documents/:id/process-ocr', async () => {
        ...
        const testApp = express();
        testApp.use(express.json());
        testApp.post('/documents/:id/process-ocr', (req, res) => {
            res.status(200).json({
                id: 1,
                filename: 'test-document.pdf',
                originalName: 'test-document.pdf',
    ...
    it('should create a bank account on POST /bank-accounts', async () => {
        ...
        const testApp = express();
        testApp.use(express.json());
        testApp.post('/bank-accounts', (req, res) => {
            res.status(201).json({
                id: 1,
                accountName: 'Main Business Account',
                accountNumber: '123456789',
    ...
    it('should import bank transactions on POST /bank-accounts/:id/import-transactions', async () => {
        ...
        const testApp = express();
        testApp.use(express.json());
        testApp.post('/bank-accounts/:id/import-transactions', (req, res) => {
            res.status(201).json([
                {
                    id: 1,
                    externalId: 'ext-123',
    ...
    it('should create a tax rate on POST /tax-rates', async () => {
        ...
        const testApp = express();
        testApp.use(express.json());
        testApp.post('/tax-rates', (req, res) => {
            const { name, rate } = req.body;
            res.status(201).json({
                id: 1,
                name,
    ...
    it('should calculate VAT on POST /tax-calculate', async () => {
        ...
        const testApp = express();
        testApp.use(express.json());
        testApp.post('/tax-calculate', (req, res) => {
            const { amount, taxRateId } = req.body;
            const vatAmount = amount * 0.25; // 25% VAT for testing
            res.status(200).json({ amount, taxRateId, vatAmount });
        });
    ...
    it('should create a tax report on POST /tax-reports', async () => {
        ...
        const testApp = express();
        testApp.use(express.json());
        testApp.post('/tax-reports', (req, res) => {
            res.status(201).json({
                id: 1,
                name: 'Q1 2024 VAT Report',
                startDate: new Date('2024-01-01'),
    ...
    it('should create a category on POST /categories', async () => {
        ...
        const testApp = express();
        testApp.use(express.json());
        testApp.post('/categories', (req, res) => {
            const { name, code, type } = req.body;
            res.status(201).json({
                id: 1,
                name,
    ...
    it('should categorize a transaction on POST /transactions/:id/categorize', async () => {
        ...
        const testApp = express();
        testApp.use(express.json());
        testApp.post('/transactions/:id/categorize', (req, res) => {
            res.status(200).json({
                id: 1,
                confidence: 0.92,
                source: 'AI_MODEL',
    ...
    it('should create a customer on POST /customers', async () => {
        ...
        const testApp = express();
        testApp.use(express.json());
        testApp.post('/customers', (req, res) => {
            const { name, organizationNumber } = req.body;
            res.status(201).json({
                id: 1,
                name,
    ...
    it('should create a financial report on POST /financial-reports', async () => {
        ...
        const testApp = express();
        testApp.use(express.json());
        testApp.post('/financial-reports', (req, res) => {
            res.status(201).json({
                id: 1,
                name: 'Q1 2024 Financial Report',
                type: 'INCOME_STATEMENT',
    ...
    it('should create a dashboard on POST /dashboards', async () => {
        ...
        const testApp = express();
        testApp.use(express.json());
        testApp.post('/dashboards', (req, res) => {
            res.status(201).json({
                id: 1,
                name: 'Executive Dashboard',
                description: 'Main dashboard for executives',
    ...
    it('should create an employee on POST /employees', async () => {
        ...
        const testApp = express();
        testApp.use(express.json());
        testApp.post('/employees', (req, res) => {
            res.status(201).json({
                id: 1,
                firstName: 'John',
                lastName: 'Doe',
    ...
    it('should create a permission on POST /permissions', async () => {
        ...
        const testApp = express();
        testApp.use(express.json());
        testApp.post('/permissions', (req, res) => {
            res.status(201).json({
                id: 1,
                name: 'Manage Users',
                code: 'MANAGE_USERS',
